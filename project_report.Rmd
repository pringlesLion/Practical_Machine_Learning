...
### Conclusions
With the data set generated from multiple measuring instruments, we can accurately predict how well a person is preforming an excercise using a relatively simple machine learning model.During my experiment, the svm model has lower accuracy but has better performance than random forest model.So for scalabitly
